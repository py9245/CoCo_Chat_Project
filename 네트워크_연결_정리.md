...
4. 브라우저가 `https://15-164-232-40.nip.io/api/...` (또는 커스텀 도메인)로 REST 요청 전송
5. DNS가 `15-164-232-40.nip.io`를 EC2 공인 IP로 해석
...
## 3. CORS·도메인 관련 설정
- **DNS**: `15-164-232-40.nip.io`는 nip.io 와일드카드로 EC2 공인 IP에 자동 매핑됩니다. 커스텀 도메인을 쓰려면 Route53 또는 외부 DNS에서 A/AAAA/CNAME 레코드를 설정하세요.
...
- **프런트**:
  ...
  - 배포 시 `VITE_API_BASE_URL=https://15-164-232-40.nip.io/api` 또는 `window.API_BASE_URL` 전역 주입
